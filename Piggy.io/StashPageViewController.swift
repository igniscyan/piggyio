//
//  StashPageViewController.swift
//  Piggy.io
//
//  Created by Brandon Clark on 10/24/19.
...
class StashPageViewController: UIViewController {
    ...
    @IBOutlet weak var twentiesLabel: UILabel!
    ...
    var tensCount: Int32 = 0
    var twentiesCount: Int32 = 0
    var onesCount: Int32 = 0
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        fivesLabel.text = String(fivesCount)
        tensLabel.text = String(tensCount)
